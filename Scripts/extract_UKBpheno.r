...
#sample ID, 23457: DHA_pct, 23456: LA_pct, 23454: MUFA_pct, 23451: Omega3_pct, 23459: Omega6/Omega3, 23445: Omega6, 23452: Omega6_pct, 23458: PUFA/MUFA, 23453: PUFA_pct, 23755: SFA_pct
df_ukb48364 <- fread("/scratch/hx37930/project/psychiatri_PUFAs/01.data/phenotype/ukb48364.tab", 
                     sep="\t", 
                     select=c("f.eid", "f.23457.0.0","f.23456.0.0","f.23454.0.0","f.23451.0.0","f.23459.0.0","f.23452.0.0","f.23458.0.0","f.23453.0.0","f.23755.0.0"))
...
df_join_reName <- df_join %>%rename(DHA=f.23450.0.0,LA=f.23449.0.0,MUFA=f.23447.0.0,Omega_3=f.23444.0.0,Omega_6=f.23445.0.0,
                                    ...
                                    Omega_6_pct=f.23452.0.0,PUFA_by_MUFA=f.23458.0.0,PUFA_pct=f.23453.0.0,TFA=f.23442.0.0,SFA=f.23448.0.0,SFA_pct=f.23755.0.0)
