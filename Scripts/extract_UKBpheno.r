...
#method #1-read data: 
df_ukb47434 <- read.table("/scratch/hx37930/rotation_ky/ukb/pheno/47434/ukb47434.tab",header=TRUE, sep="\t")
df_ukb48364 <- read.table("/scratch/hx37930/rotation_ky/ukb/pheno/48364/ukb48364.tab",header=TRUE, sep="\t")
...
#sample ID, 23450: DHA, 23449: LA, 23447: MUFA, 23444: Omega3, 23445: Omega6, 23446: PUFA, 23442: TFA
df_ukb47434 <- fread("/scratch/hx37930/project/psychiatri_PUFAs/01.data/phenotype/ukb34137.tab", sep="\t", select=c("f.eid", "f.23450.0.0","f.23449.0.0","f.23447.0.0","f.23444.0.0","f.23445.0.0","f.23446.0.0","f.23442.0.0"))
df_ukb47434 <- as_tibble(df_ukb47434)
#sample ID, 23457: DHA_pct, 23456: LA_pct, 23454: MUFA_pct, 23451: Omega3_pct, 23459: Omega6/Omega3, 23445: Omega6, 23452: Omega6_pct, 23458: PUFA/MUFA, 23453: PUFA_pct
df_ukb48364 <- fread("/scratch/hx37930/project/psychiatri_PUFAs/01.data/phenotype/ukb48364.tab", sep="\t", select=c("f.eid", "f.23457.0.0","f.23456.0.0","f.23454.0.0","f.23451.0.0","f.23459.0.0","f.23452.0.0","f.23458.0.0","f.23453.0.0"))
...
Omega_6_pct=f.23452.0.0,PUFA_by_MUFA=f.23458.0.0,PUFA_pct=f.23453.0.0,TFA=f.23442.0.0)
